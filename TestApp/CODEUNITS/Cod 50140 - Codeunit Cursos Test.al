codeunit 50140 "Codeunit Cursos Test"
{
    ...
    //[MessageHandler] // para mostrar en la interfaz los mensajes, que se ejecutarian al cliente. NO se coloca aqui
    procedure SelectEditionOnSalesDocuments_CheckEditionMaxStudents()
    begin
        //SelectEditionOnSalesDocuments_CheckEditionMaxStudents("Sales Document Type"::Quote);
        SelectEditionOnSalesDocuments_CheckEditionMaxStudents("Sales Document Type"::Order);
        /*   SelectEditionOnSalesDocuments_CheckEditionMaxStudents("Sales Document Type"::"Blanket Order");
          SelectEditionOnSalesDocuments_CheckEditionMaxStudents("Sales Document Type"::Invoice);
          SelectEditionOnSalesDocuments_CheckEditionMaxStudents("Sales Document Type"::"Credit Memo");
          SelectEditionOnSalesDocuments_CheckEditionMaxStudents("Sales Document Type"::"Return Order"); */
    end;


    local procedure SelectEditionOnSalesDocuments_CheckEditionMaxStudents("Sales Document Type": Enum "Sales Document Type")
    var //COMENTAR PARTE DEL TEST PARA QUE NO DE RRO, YA QUE FALTAN LAS LIBRERIAS INSTALADAS, ERROR A COMENTAR
        Course: Record Course;
        CourseEdition: Record "Course Edition";
        SalesHeader: Record "Sales Header";
